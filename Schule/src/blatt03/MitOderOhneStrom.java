...
public class MitOderOhneStrom {
    public static void main(String[] args) {
        ...
        gatter = gatter.toUpperCase(); //Groß und kleinschreibungsfehler abfangen
        if (gatter.equals("NOT")) {
            // Example mäßige Erklärung für alle Cases:
            // Erklärung, dann eingabe der 1-2 Werte (true / false)
            ...
            System.out.printf("%b NOT = %b", strom1, !strom1); // Verarbeitung und Ausgabe
            ...
            System.out.println("Befindet sich auf dem zweiten Eingang Strom? (true/false)");
            Boolean strom2 = input.nextBoolean();
            System.out.printf("%b XOR %b = %b", strom1, strom2, strom1 != strom2);
        }else if (gatter.equals("OR")) {
            System.out.println("Das OR-Gatter:\nDas Gatter verfügt über 2 Eingänge und einen Ausgang.\nBefindet sich auf dem ersten Eingang Strom? (true/false)");
            Boolean strom1 = input.nextBoolean();
            System.out.println("Befindet sich auf dem zweiten Eingang Strom? (true/false)");
            Boolean strom2 = input.nextBoolean();
            System.out.printf("%b OR %b = %b", strom1, strom2, strom1 != strom2 || strom1 && strom2);
        }else{ // Alle falschen eingaben werden benannt und das Programm wird beendet
